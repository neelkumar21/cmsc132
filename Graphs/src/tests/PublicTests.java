...
public class PublicTests {
	...
	@Test
	public void pub05ShortestPathForSameStartEndVertex() {
		String testName = new Object() {
		}.getClass().getEnclosingMethod().getName();
		Graph<Double> graph = createGraph();
		String startVertex = "ST";
		...
		int shortestPathCost = graph.doDijkstras(startVertex, startVertex, shortestPath);
		results.append("Shortest Path Cost: " + shortestPathCost + "\n");
		results.append("Shortest Path: " + shortestPath + "\n");
		results.append(TestingSupport.HARDCODEMARKER);
